...
function findLongestWord(words) {
    ...
    words.forEach(function (element, index) {
        ...
        wordLength[element] = element.length
...
function sumNumbers (numArray) {
    let sum = 0;
    numArray.forEach(function (element) { sum += element; });
    return sum;
}
...
function sum(numArray) {
    ...
    numArray.forEach(function (element) { 
        if(typeof element === 'object') {
            // throw 'value not allowed (object)!';
            sum = NaN;
            return undefined;
            }
    ...
    if (isNaN(sum)) {
        // console.log('here!');  
        error = new Error("objects not allowed!");
        return error;
        }
    return sum;
}
...
function uniquifyArray(wordsArray) {
    ...
    wordsArray.forEach(function(element, index, stringArray) {
          ...
          console.log(element, duplicate);  
          if(duplicate == false)
              // uniqArray = uniqArray.push(element);
              // console.log(element);
